...
fn main() {
    let root = "/Users/camden/Halo/halo3_mcc/tags/levels/multi/riverworld/fx/waterfall";
    for name in ["waterfall_top", "waterfall_mid", "waterfall_base"] {
        let tag = TagFile::read(&format!("{root}/{name}.effect")).unwrap();
