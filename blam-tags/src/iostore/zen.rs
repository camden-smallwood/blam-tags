...
use super::name_map::{FMappedName, FNameMap};
...
// --- Version heuristics (ported from retoc's version_heuristics.rs) ---
// Only the two functions the Zen package deserializer needs are ported here;
// the legacy-package heuristic (which depends on retoc's legacy_asset module)
// is intentionally omitted.

// Returns true if given zen package should deserialize bulk data
fn heuristic_zen_has_bulk_data(summary: &FZenPackageSummary, container_header_version: EIoContainerHeaderVersion, current_reader_pos: i32) -> bool {
...
fn heuristic_zen_version_from_package_file_version(package_file_version: FPackageFileVersion, container_header_version: EIoContainerHeaderVersion) -> EZenPackageVersion {
...
fn heuristic_zen_package_version(optional_package_version: Option<FPackageFileVersion>, container_version: EIoStoreTocVersion, container_header_version: EIoContainerHeaderVersion, has_bulk_data: bool) -> Result<FZenPackageVersioningInfo> {
